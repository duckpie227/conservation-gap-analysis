### SR version of 0-set_working_directory.R
...
### Last Updated: October 2024; source updated June 2023 ; first written Dec 2020
### Running in R version 4.4.1; source used R version 4.3.0
...
## For additional user or workstation (fill in each ________ with your file path)
} else if (Sys.info()[4] == "MacBookPony.local") {
  ...
  log_loc <- "/Users/admin/Documents/School/NU/Artocarpus/gap-analysis_passwords.rtf"
  ...
  gap_dir <- "/Users/admin/Documents/School/NU/Artocarpus/"
